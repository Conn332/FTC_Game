...
function enemy:new(x,y,player,level)
	...
	local o = {
		...
		["player"] = player,
		["images"] = {
			{love.graphics.newImage("final_sprites/enemies/slime_3_1.png"),love.graphics.newImage("final_sprites/enemies/slime_3_1_flipped.png")},
			{love.graphics.newImage("final_sprites/enemies/slime_3_2.png")},
...
function enemy:update(dt)
	...
	if self.hp > 0 then
		...
		if self:getDistance() > 50 and self:getDistance() < 400  and self.windup <= 0 and self.aTimer <= 0 and self.ouch <= 0 then
