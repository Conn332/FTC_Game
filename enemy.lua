...
function enemy:new(x,y,player,level)
	...
	local o = {
		...
		["player"] = player,
		["images"] = {
			{love.graphics.newImage("final_sprites/enemies/slime_1_1.png"),love.graphics.newImage("final_sprites/enemies/slime_1_1_flipped.png")},
			{love.graphics.newImage("final_sprites/enemies/slime_1_2.png")},
